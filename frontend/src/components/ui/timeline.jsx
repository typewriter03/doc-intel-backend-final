  ...
  return (
    <div
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p
          className="text-neutral-700 dark:text-neutral-300 text-lg md:text-xl max-w-2xl leading-relaxed">
          Our platform simplifies complex document processing into a seamless three-step intelligence workflow.
        </p>
      </div>
